                ...
                <div class="resume-item d-flex flex-column flex-md-row mb-5">
                    <div class="resume-content mr-auto">
                        ...
                        <ul>
                            ...
                            <li>Handled student and employee questions on tech-related issues.</li>
                            <li>Monitored a computer lab.</li>
                        </ul>
                    </div>
                    <div class="resume-date text-md-right"> <span class="text-primary">October 2013 - November 2014</span> </div>
                </div>
                <div class="resume-item d-flex flex-column flex-md-row mb-5">
                    <div class="resume-content mr-auto">
                        <h3 class="mb-0">Inventory Control Specialist</h3>
                        <div class="subheading mb-3">Walmart</div>
                        <ul>
                            <li>Unloaded product with an eight-man crew in a high-pace retail environment.</li>
                            <li>Monitored inventory throughout the entire local warehouse, as well as store shelves.</li>
                            <li>Handled receiving, advertising signage, and visual organization of merchandise.</li>
                        </ul>
                    </div>
                    <div class="resume-date text-md-right"> <span class="text-primary">April 2010 - April 2011</span> </div>
                </div>
            </div>
        </section>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
            <div class="my-auto">
                ...
                <ul class="list-inline list-icons">
                    ...
                    <li class="list-inline-item"> <i class="devicons devicons-photoshop"></i> </li>
                </ul>
                ...
                <ul class="fa-ul mb-0">
                    ...
                    <li> <i class="fa-li fa fa-check"></i> Develop your site with the look and feel of a modern webpage.</li>
                    <li> <i class="fa-li fa fa-check"></i> Utilize consistent best practices to maximize the number of devices that your webpage can be viewed on.</li>
