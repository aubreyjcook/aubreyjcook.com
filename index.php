            ...
            <div class="modal-content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="modal-body">
                              <h2>Conditional Page Loading</h2>
                              <hr class="star-light"> <img class="img-fluid img-centered" src="img/portfolio/portfolioThumb02.jpg" alt="">
                              <p>LAMP-Stack based PHP/Javascript library written with conditional logic to simplify the loading of content on web pages based on specific page location. Review the project files on my <a target="_blank" href="https://github.com/aubreyjcook/Conditional-Page-Loading_LAMP">Github.</a></p>
                              <ul class="list-inline item-details">
                                <li>Date: <strong>2018</strong> </li>
                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                                <div class="modal-body">
                                    ...
                                    <hr class="star-primary"> <img class="img-fluid img-centered" src="img/portfolio/portfolioThumb04.jpg" alt="">
                                    <p>My personal website located at <a href="https://www.aubreyjcook.com">aubreyjcook.com</a></p>
                                    <ul class="list-inline item-details">
                                        <li>Date: <strong>2017</strong> </li>
                                        <li>Service: <strong>Web Development</strong> </li>
